...
class Server6000 {
	...
	public Server6000() throws UnknownHostException, IOException{
		int port = 6000;
					...
					try{
						...
						while(socket.isConnected()){
							...
							// Requesting list of members
								...
								PrintWriter pw = new PrintWriter(master.getOutputStream(),true);
								pw.println("getMembers_"+recieved[1]+"_"+name+"_6000");
							}
							...
							// Chat message
								...
								PrintWriter pw = new PrintWriter(master.getOutputStream(),true);
								pw.println("chat_"+recieved[1]+"_"+name+"_"+recieved[2]+"_6000_"+recieved[3]);
							}
							else {
								PrintWriter client_out = new PrintWriter(socket.getOutputStream(),true);
